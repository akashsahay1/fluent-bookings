...
<div class="wrap fluent-booking-form-builder" id="fb-form-builder">
    <h1><?php echo $is_edit ? esc_html__('Edit Form', 'fluent-bookings') : esc_html__('Create New Form', 'fluent-bookings'); ?></h1>

    <div class="fb-builder-container">
        <!-- Sidebar with field types -->
        <div class="fb-builder-sidebar">
            <h3><?php esc_html_e('Form Fields', 'fluent-bookings'); ?></h3>
        ...
        <div class="fb-builder-main">
            ...
            <div class="fb-builder-tabs">
                <button class="fb-tab-button active" data-tab="fields"><?php esc_html_e('Fields', 'fluent-bookings'); ?></button>
                <button class="fb-tab-button" data-tab="settings"><?php esc_html_e('Settings', 'fluent-bookings'); ?></button>
                <button class="fb-tab-button" data-tab="styles"><?php esc_html_e('Styles', 'fluent-bookings'); ?></button>
                <button class="fb-tab-button" data-tab="notifications"><?php esc_html_e('Notifications', 'fluent-bookings'); ?></button>
            </div>
            ...
            <div class="fb-tab-content active" data-tab-content="fields">
                <div class="fb-form-header">
                    <div class="fb-form-group">
                        <label><?php esc_html_e('Form Title', 'fluent-bookings'); ?></label>
                        <input
                            type="text"
                            id="fb-form-title"
                            placeholder="<?php esc_attr_e('Enter form title', 'fluent-bookings'); ?>"
                            value="<?php echo $is_edit ? esc_attr($form_data['title']) : ''; ?>"
                        >
                    </div>

                    <div class="fb-form-group">
                        <label><?php esc_html_e('Form Description (Optional)', 'fluent-bookings'); ?></label>
                        <textarea
                            id="fb-form-description"
                            rows="3"
                            placeholder="<?php esc_attr_e('Enter form description', 'fluent-bookings'); ?>"
                ...
                <div class="fb-form-fields-area">
                    <h3><?php esc_html_e('Form Fields', 'fluent-bookings'); ?></h3>
                    <p class="description"><?php esc_html_e('Drag fields from the left panel or reorder existing fields.', 'fluent-bookings'); ?></p>
            ...
            <div class="fb-tab-content" data-tab-content="settings">
                <h3><?php esc_html_e('Form Settings', 'fluent-bookings'); ?></h3>

                <div class="fb-form-group">
                    <label><?php esc_html_e('Appointment Duration (minutes)', 'fluent-bookings'); ?></label>
                    <input
                        type="number"
                ...
                <div class="fb-form-group">
                    <label><?php esc_html_e('Buffer Time Between Appointments (minutes)', 'fluent-bookings'); ?></label>
                    <input
                        type="number"
                ...
                <div class="fb-form-group">
                    <label><?php esc_html_e('Minimum Booking Notice (hours)', 'fluent-bookings'); ?></label>
                    <input
                        type="number"
                ...
                <div class="fb-form-group">
                    <label><?php esc_html_e('Maximum Days in Advance', 'fluent-bookings'); ?></label>
                    <input
                        type="number"
                ...
                <div class="fb-form-group">
                    <label><?php esc_html_e('Confirmation Message', 'fluent-bookings'); ?></label>
                    <textarea
                        id="fb-setting-confirmation"
                        rows="4"
                    ><?php esc_html_e('Thank you! Your appointment has been booked successfully.', 'fluent-bookings'); ?></textarea>
                </div>

                <div class="fb-form-group">
                    <label><?php esc_html_e('Success Action', 'fluent-bookings'); ?></label>
                    <select id="fb-setting-success-action">
                        <option value="message"><?php esc_html_e('Show Message', 'fluent-bookings'); ?></option>
                        <option value="redirect"><?php esc_html_e('Redirect to URL', 'fluent-bookings'); ?></option>
                    </select>
                </div>

                <div class="fb-form-group fb-redirect-url-group" style="display: none;">
                    <label><?php esc_html_e('Redirect URL', 'fluent-bookings'); ?></label>
                    <input
                        type="url"
            ...
            <div class="fb-tab-content" data-tab-content="styles">
                <h3><?php esc_html_e('Form Styles', 'fluent-bookings'); ?></h3>

                <div class="fb-style-section">
                    <h4><?php esc_html_e('Form Container', 'fluent-bookings'); ?></h4>
                    <div class="fb-style-row">
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Background Color', 'fluent-bookings'); ?></label>
                            <input type="text" class="fb-color-picker" id="fb-style-form-bg" value="#ffffff">
                        </div>
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Border Color', 'fluent-bookings'); ?></label>
                            <input type="text" class="fb-color-picker" id="fb-style-form-border-color" value="#e0e0e0">
                        </div>
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Border Width (px)', 'fluent-bookings'); ?></label>
                            <input type="number" id="fb-style-form-border-width" value="1" min="0" max="10">
                        </div>
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Border Radius (px)', 'fluent-bookings'); ?></label>
                            <input type="number" id="fb-style-form-border-radius" value="5" min="0" max="50">
                        </div>
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Padding (px)', 'fluent-bookings'); ?></label>
                ...
                <div class="fb-style-section">
                    <h4><?php esc_html_e('Labels', 'fluent-bookings'); ?></h4>
                    <div class="fb-style-row">
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Color', 'fluent-bookings'); ?></label>
                            <input type="text" class="fb-color-picker" id="fb-style-label-color" value="#333333">
                        </div>
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Font Size (px)', 'fluent-bookings'); ?></label>
                            <input type="number" id="fb-style-label-font-size" value="14" min="10" max="30">
                        </div>
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Font Weight', 'fluent-bookings'); ?></label>
                        ...
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Font Family', 'fluent-bookings'); ?></label>
                ...
                <div class="fb-style-section">
                    <h4><?php esc_html_e('Input Fields', 'fluent-bookings'); ?></h4>
                    <div class="fb-style-row">
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Background Color', 'fluent-bookings'); ?></label>
                        ...
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Text Color', 'fluent-bookings'); ?></label>
                ...
                <div class="fb-style-section">
                    <h4><?php esc_html_e('Submit Button', 'fluent-bookings'); ?></h4>
                    <div class="fb-style-row">
                        <div class="fb-form-group">
                            <label><?php esc_html_e('Background Color', 'fluent-bookings'); ?></label>
            ...
            <div class="fb-tab-content" data-tab-content="notifications">
                <h3><?php esc_html_e('Email Notifications', 'fluent-bookings'); ?></h3>

                <div class="fb-notification-section">
                    <h4><?php esc_html_e('Customer Notification', 'fluent-bookings'); ?></h4>
                    <div class="fb-form-group">
                        <label>
                            <input type="checkbox" id="fb-notif-customer-enabled" checked>
                            <?php esc_html_e('Send confirmation email to customer', 'fluent-bookings'); ?>
                        </label>
                    </div>
                    <div class="fb-form-group">
                        <label><?php esc_html_e('Email Subject', 'fluent-bookings'); ?></label>
                        <input
                            type="text"
                    ...
                    <div class="fb-form-group">
                        <label><?php esc_html_e('Email Message', 'fluent-bookings'); ?></label>
                        <textarea
...
Thank you!</textarea>
                ...
                <div class="fb-notification-section">
                    <h4><?php esc_html_e('Admin Notification', 'fluent-bookings'); ?></h4>
                    <div class="fb-form-group">
                        <label>
                            <input type="checkbox" id="fb-notif-admin-enabled" checked>
                            <?php esc_html_e('Send notification to admin', 'fluent-bookings'); ?>
                        </label>
                    </div>
                    <div class="fb-form-group">
                        <label><?php esc_html_e('Email Subject', 'fluent-bookings'); ?></label>
                ...
                <div class="fb-notification-section">
                    <p class="description">
                        <?php esc_html_e('Available merge tags:', 'fluent-bookings'); ?>
            ...
            <div class="fb-builder-actions">
                <button type="button" id="fb-save-form" class="button button-primary button-large">
                    <?php echo $is_edit ? esc_html__('Update Form', 'fluent-bookings') : esc_html__('Create Form', 'fluent-bookings'); ?>
                </button>
                <a href="<?php echo esc_url(admin_url('admin.php?page=fluent-booking-forms')); ?>" class="button button-large">
                    <?php esc_html_e('Cancel', 'fluent-bookings'); ?>
                </a>
            </div>
        </div>
    </div>
